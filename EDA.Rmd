...
values <- c(df_state_edu$values[1], df_state_edu$values[5], df_state_edu$values[9], df_state_edu$values[2], df_state_edu$values[6], df_state_edu$values[10], df_state_edu$values[3], df_state_edu$values[7], df_state_edu$values[11], df_state_edu$values[4], df_state_edu$values[8], df_state_edu$values[12])
```
